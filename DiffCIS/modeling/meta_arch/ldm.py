...
from DiffCIS.checkpoint.diffcis_checkpointer import LdmCheckpointer
from DiffCIS.modeling.meta_arch.clip import ClipAdapter
from DiffCIS.utils.file_io import PathManager
