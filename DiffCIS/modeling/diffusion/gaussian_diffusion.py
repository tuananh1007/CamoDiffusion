...
def get_named_beta_schedule(schedule_name, num_diffusion_timesteps):
    ...
    elif schedule_name == "ldm_linear":
        # ref: https://github.com/CompVis/stable-diffusion/blob/d39f5b51a8d607fd855425a0d546b9f871034c3d/ldm/modules/diffusionmodules/util.py#L22 # noqa
        scale = 1000 / num_diffusion_timesteps
...
class GaussianDiffusion:
    ...
    def ddim_reverse_sample_loop_progressive(
        ...
        img = noise
        # NOTE: we need to add noise starting from step 0 to num_timesteps - 1
